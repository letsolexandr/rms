...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('mrs', '0008_alter_mobilizationpostponement_detail_file_and_more'),
    ]

    operations = [
        migrations.AlterModelOptions(
            name='mobilizationpostponementdoc',
            options={'verbose_name': 'Документ про відстрочку', 'verbose_name_plural': 'Документи про відстрочку (від особи) '},
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('military_person', models.ForeignKey(help_text='Пошук за РНОКПП або паспотом', on_delete=django.db.models.deletion.PROTECT, to='mrs.militaryperson', verbose_name='Військовозобовязаний')),
            ],
            options={
