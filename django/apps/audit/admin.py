...
class CRUDEventAdmin(EasyAuditModelAdmin):
    list_display = ['get_event_type_display', 'get_content_type', 'object_id', 'object_repr_link', 'user_link', 'user_as_string','datetime','change_comment']
    ...
    readonly_fields = ['event_type', 'object_id', 'get_content_type',
                       ...
                       'user_pk_as_string','user_as_string', 'datetime', 'changed_fields_prettified']
...
class LoginEventAdmin(EasyAuditModelAdmin):
    list_display = ['datetime', 'get_login_type_display', 'user_link','user_as_string', "get_username", 'remote_ip']
    date_hierarchy = 'datetime'
    list_filter = LOGIN_EVENT_LIST_FILTER
    search_fields = LOGIN_EVENT_SEARCH_FIELDS
    readonly_fields = ['login_type', 'get_username', 'user_as_string','get_user', 'remote_ip', 'datetime', ]
